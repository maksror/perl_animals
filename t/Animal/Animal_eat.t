...
describe "Передаём в функцию объект с объявленным звуком и валидную строку -" => sub {
...
describe "Передаём в функцию объект с объявленным звуком и пустую строку -" => sub {
